...
function Login() {
  ...
  return (
    <AuthLayout
      title="Login"
      subtitle="Access your conversations, team channels, and shared files."
      footer={
        <>
          <p>
          ...
          <p className="mt-2 text-gray-500">
            <Link to="/forgot-password" className="hover:text-indigo-600 hover:underline cursor-pointer">
              Forgot password?
            </Link>
          </p>
        </>
